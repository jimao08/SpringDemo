...
public class MyServer {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String webappDir = "C:\\Users\\admin\\tools\\workspace\\springdemo\\src\\main\\webapp";

        final InetSocketAddress inetSocketAddress = new InetSocketAddress("localhost", 8011);
